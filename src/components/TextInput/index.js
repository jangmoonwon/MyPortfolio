...
const Container = styled.input`
  ...
  border: ${(props) => {
    ...
    if (props.id === 'userid_2' || props.id === 'userpwd_2')
      return '2.5px solid #a4b0be';
    if (props.id === 'userid_3' || props.id === 'userpwd_3')
      return '1.5px solid #c0392b';
  }};
  border-bottom: ${(props) => {
  ...
  border-radius: ${(props) => {
    if (props.id === 'userid_3' || props.id === 'userpwd_3') return '3.5px';
  }};
  outline: 0;
  margin-left: ${(props) => {
    if (props.id === 'userid_3' || props.id === 'userpwd_3') return '30px';
  }};
  padding: ${(props) => {
    if (props.id === 'userid_1' || props.id === 'userpwd_1') return '0.5rem 0';
    if (props.id === 'userid_2' || props.id === 'userpwd_2')
      return '0.5rem 5px';
  }};
  box-shadow: none;
